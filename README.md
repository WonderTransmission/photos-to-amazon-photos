...
1. [Requirements](docs/requirements.md) — what the tool must do and why. **(current phase)**
2. Design — how it will do it. *(not yet written)*
...
Draft / planning. See [`docs/requirements.md`](docs/requirements.md) for the current spec and
its open questions.
