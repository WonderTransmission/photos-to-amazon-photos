from image_quality_detector import discover, naming
...
def test_discover_images_excludes_quarantined_files(tmp_path):
    original = tmp_path / "a.jpg"
    _touch(original)
    quarantined = naming.quarantine_path_for(tmp_path / "b.jpg", "blurry")
    _touch(quarantined)
