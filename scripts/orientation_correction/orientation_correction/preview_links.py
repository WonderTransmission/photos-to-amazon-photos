...
def _write_section(lines: list[str], label: str, paths: list[Path]) -> bool:
...
def write_preview_links(
    ...
    *,
    ...
    lines: list[str] = [
        ...
        "# by directory, for a manual sanity check that the re-orientation makes sense.",
        "set -euo pipefail",
        "",
    ]

    wrote_any = False
    wrote_any |= _write_section(lines, "Corrected", corrected)
